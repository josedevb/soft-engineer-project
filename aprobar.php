...
<div class="container">
	<div class="row" style="margin-top: 10%;">
		<div class="col-md-12 parrafo">
				<h1>¿Esta seguro que sea aprobar la solicitud?</h1>
				<?php 
								if ( isset($_POST['BtnEnviar']) )
								{
									$id = $_GET['id'];
						        	$mysqli->query("UPDATE solicitudes set idestado = 3 where idsolicitud = $id");
						  ...
						  ?>
						  <br>
				<a href="index.php?art=adminsolicitudes">
