...
$query1 = $mysqli->query("SELECT * FROM equipos where idequipo=2 ");
...
<div class="container-fluid">
    <div class="row">
                <div class="col-md-7">
                    <img src="image/op2.jpg" style="display:block; margin-top: 10%;"  alt="">
                </div>

                <div class="col-md-4" >
                    <h2 style="color: black">All-in-One Pavilion 24-b007la</h2>
                    <p style="color: black" style="font-size: 50%">All-in-One Pavilion 24-b007la cubre todos los requerimientos en cualquier espacio, especial para diseñadores y arquitectos..</p>
                    ...
                    <ul style="color: black;margin: 2px;padding: 2px;">
                        ...
                        echo "<list style='color: black;margin: 10px;padding: 10px;' > <textarea placeholder='Indique sus razones' required cols='40' rows='4' id='descripcion' name='descripcion'></textarea></li>"; 
                           ...
                           if ( isset($_POST['BtnEnviar']) )
                                {
                    $query2 = $mysqli->query("INSERT INTO solicitudes (idsolicitud, idusuario, idequipo, idestado, fechaini, fechafin, vencido, motivo) values (null, $id, 2, 1, '$fechaini', '$fechafin', 0, '$motivo') ");

    $query3 = $mysqli->query("UPDATE equipos SET cantidad = cantidad - 1 where idequipo = 2 ");
